...
void Simulator::grabScreen()
{
    ...
    std::string densityFile = "../records/smoke5/smoke_frame" + std::to_string(mFrameNum) + ".bgeo";
    ...
    snprintf(anim_filename, 2048, "../records/smoke5/smoke_%04d.png", mFrameNum); 
    ...
    std::string particleFile = "../records/smoke5/smoke_frame" + std::to_string(mFrameNum) + ".bgeo";
